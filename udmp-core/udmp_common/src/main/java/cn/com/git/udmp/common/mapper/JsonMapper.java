...
package cn.com.git.udmp.common.mapper;
...
public class JsonMapper extends ObjectMapper {
     ...
     */
    private static void initResponseHeader(final ServletResponse response) {
     ...
     */
    public void renderJsonToResponse(final Object data, final ServletResponse response) {
