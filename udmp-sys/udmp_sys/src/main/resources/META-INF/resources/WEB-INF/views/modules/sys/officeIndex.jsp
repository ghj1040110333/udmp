...
<body>
	<div>
		...
		<div id="officeContent" class="col-sm-10" style="padding:0;"></div>
	</div>
	<script type="text/javascript">
		var setting = {
			...
			callback : {
				onClick : function(event, treeId, treeNode) {
					...
					var parentIds = treeNode.pIds + id;
					$("#officeContent").load("${ctx}/sys/office/list?id=" + id + "&rootId=" + parentId + "&parentIds=" + parentIds);
				}
			}
		};
		...
		refreshTree();
		$("#officeContent").load("${ctx}/sys/office/list");
	</script>
</body>
</html>