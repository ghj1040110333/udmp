...
<script type="text/javascript">
  idefine('menuForm',function(require,exports,module){
    var tools = require('udmp/lib/util_tool');
    $('body').on('run.menuForm', function() {
      $("#btnSubmit").on("click", function() {
        $.post("${ctx}/sys/menu/save", tools.serializeObject($("#inputForm")), function(data) {
          if(data) {
            if(data.success) {
  ...
  seajs.use('menuForm',function(){
    $('body').trigger("run.menuForm");
  });
</script>
