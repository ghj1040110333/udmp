...
import cn.com.git.udmp.common.utils.CookieUtils;
...
public class LoginController extends BaseController {
	...
	public String index(HttpServletRequest request, HttpServletResponse response) {
		...
		// try {
		// byte[] bytes =
		// cn.com.git.udmp.common.utils.FileUtils.readFileToByteArray(
		// cn.com.git.udmp.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
