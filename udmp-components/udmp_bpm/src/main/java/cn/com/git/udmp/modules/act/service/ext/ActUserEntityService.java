...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new cn.com.git.udmp.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new cn.com.git.udmp.modules.sys.entity.User(null, userId)))){
