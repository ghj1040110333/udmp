...
package cn.com.git.udmp.modules.act.entity;
...
import cn.com.git.udmp.common.persistence.BaseEntity;
import cn.com.git.udmp.common.utils.StringUtils;
import cn.com.git.udmp.common.utils.TimeUtils;
import cn.com.git.udmp.modules.act.utils.Variable;
...
//	private Variable taskVars; 	// 流程任务变量
	...
	public void setProcIns(ProcessInstance procIns) {
		...
		if (procIns != null && procIns.getBusinessKey() != null){
			if(procIns.getBusinessKey().indexOf(":")>0){
