...
<%@page import="activiti_maven_project.com.git.redis.impl.RedisServiceImpl"%>
<%@page import="org.springframework.context.ApplicationContext"%>
<%@page import="activiti_maven_project.com.git.user.Users"%>
...
<head>
	...
	<link rel="stylesheet" href="<%=basePath %>css/index2.css" type="text/css" />
...
<div class="ui-layout-center">
	...
	<div class="ui-layout-north">
		<div class="header">
			<div class="clearfix">
				<!-- <div class="logo"><img src="<%=basePath %>images/logo.png" class="img-responsive" alt="Responsive image"></div> -->
				<div class="title fl">
					&nbsp;
				<span class="label label-danger">工作流平台</span>
				</div>
 				
				<div class="list fr">
					<c:url value="/logout" var="logoutUrl"/>
					<span class="glyphicon glyphicon-user" aria-hidden="true">&nbsp;<%=usercd%>&nbsp;</span>
					<button type="button" class="btn btn-success btn-sm" onclick="location='${logoutUrl}'">
  						<span class="glyphicon glyphicon-log-in"></span>&nbsp;EXIT
					</button>
				</div>
			</div>
			<div class="navv clearfix">
				<ul class="nav nav-pills">
					<li id="home" role="presentation"><a href="#">首页</a></li>
					<li id="mbgl" role="presentation"><a href="#">配置管理</a></li>
					<li id="" role="presentation"><a href="JavaScript:refresh()">重新加载</a></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="ui-layout-south ">
		<div class="footer">
			<span class="label label-info">版权所有 ©</span>
		</div>
	</div>
