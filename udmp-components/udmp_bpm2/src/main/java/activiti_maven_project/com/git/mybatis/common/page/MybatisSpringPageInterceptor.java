package activiti_maven_project.com.git.mybatis.common.page;
...
//			Page page = pageThreadLocal.get();
			...
			// 查找Page类型的参数对象
			Object parameterObj2 = boundSql.getParameterObject();
			System.out.println("parameterObj2==="+parameterObj2);
			Page<?> page = findPageObject(parameterObj2);
