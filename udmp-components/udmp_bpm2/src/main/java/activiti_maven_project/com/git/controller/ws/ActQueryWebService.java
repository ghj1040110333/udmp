package activiti_maven_project.com.git.controller.ws;
...
@WSDLDocumentationCollection(  
	    {  
	        @WSDLDocumentation(value = "查询管理接口，主要功能包括个人任务查询，岗位任务查询等.作者：gunjack，邮箱：wangzhiyin@git.com.cn",  
...
public interface ActQueryWebService {
	 ...
	 * @throws BpmException
	 */
	public String conutWorkList(String _variablesJson)
			throws BpmException;
	 ...
	 * @throws BpmException
	 */
	public String queryHisList(String _variablesJson)
			throws BpmException;
	/**
	 * 统计个人历史流程
	 * @param _variablesJson
	 ...
	 * @throws BpmException
	 */
	public String queryHisTaskList(String _variablesJson)
			throws BpmException;
