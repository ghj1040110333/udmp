...
public class ModelController extends BaseController {
	...
	@ResponseBody
	public void delete(@RequestBody String modelId ,HttpServletRequest request,HttpServletResponse response, Model model)  { 
	...
	@ResponseBody	
	public void pic(@PathVariable("modelId") String modelId ,HttpServletRequest request,HttpServletResponse response, Model model) throws BpmException{
    ...
    */
     ...
     */
	  ...
	  @ResponseBody
	  public String create(@RequestBody String parms,
