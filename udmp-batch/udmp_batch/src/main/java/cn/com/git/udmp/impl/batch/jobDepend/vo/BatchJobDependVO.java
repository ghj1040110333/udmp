package cn.com.git.udmp.impl.batch.jobDepend.vo;
...
/**
 * @description BatchJobDependVO对象
 * @author yangfeiit@newchinalife.com
 * @date 2015-02-04 11:08:09
 */
public class BatchJobDependVO extends DataObject implements IBaseBatchVO{
    ...
    public String toString() {
        return "BatchJobDependVO [" + "dependStatus=" + dependStatus + "," + "actionJobId=" + actionJobId + ","
