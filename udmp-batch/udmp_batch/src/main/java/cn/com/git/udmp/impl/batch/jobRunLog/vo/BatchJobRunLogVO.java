package cn.com.git.udmp.impl.batch.jobRunLog.vo;
...
/**
 * @description BatchJobRunLogVO对象
 * @author yangfeiit@newchinalife.com
 * @date 2015-02-04 15:06:12
 */
public class BatchJobRunLogVO extends DataObject implements IBaseBatchVO{
    ...
    public String toString() {
        return "BatchJobRunLogVO [" + "jobRunLogId=" + jobRunLogId + "," + "logTime=" + logTime + "," + "logInfo="
