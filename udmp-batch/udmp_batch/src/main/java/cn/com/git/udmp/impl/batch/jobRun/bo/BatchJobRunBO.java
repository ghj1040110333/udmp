package cn.com.git.udmp.impl.batch.jobRun.bo;
...
/**
 * @description BatchJobRunBO对象
 * @author yangfeiit@newchinalife.com
 * @date 2015-02-04 14:34:02
 */
public class BatchJobRunBO extends DataObject implements IBaseBatchBO{
    ...
    public String toString() {
        return "BatchJobRunBO [" + "successCnt=" + successCnt + "," + "totalCnt=" + totalCnt + "," + "createTime="
                ...
                + "," + "jobName" + jobName + "processDateStart" + processDateStart +"processDateEnd"+ processDateEnd +"]";
    }
