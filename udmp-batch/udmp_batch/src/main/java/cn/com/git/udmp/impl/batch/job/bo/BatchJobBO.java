package cn.com.git.udmp.impl.batch.job.bo;
...
/**
 * @description BatchJobBO对象
 * @author yangfeiit@newchinalife.com
 * @date 2015-02-04 09:48:05
 */
public class BatchJobBO extends DataObject implements IBaseBatchBO{
    ...
    /**
     * @Fields batchJobParamList : 预留版本号。默认值：1.0.0
     */
    private List<BatchJobParamBO> batchJobParamList;
    
    /**
     * @Fields batchJobPostDependList : 预留版本号。默认值：1.0.0
     */
    private List<BatchJobDependBO> batchJobPostDependList;
    
    /**
     * @Fields batchJobPreDependList : 预留版本号。默认值：1.0.0
     */
    private List<BatchJobDependBO> batchJobPreDependList;
    ...
    public List<BatchJobDependBO> getBatchJobPreDependList() {
        return batchJobPreDependList;
    }

    public void setBatchJobPreDependList(List<BatchJobDependBO> batchJobPreDependList) {
        this.batchJobPreDependList = batchJobPreDependList;
    }

    public List<BatchJobDependBO> getBatchJobPostDependList() {
        return batchJobPostDependList;
    }

    public void setBatchJobPostDependList(List<BatchJobDependBO> batchJobPostDependList) {
        this.batchJobPostDependList = batchJobPostDependList;
    }

    public List<BatchJobParamBO> getBatchJobParamList() {
        return batchJobParamList;
    }

    public void setBatchJobParamList(List<BatchJobParamBO> batchJobParamList) {
    ...
    public String toString() {
        return "BatchJobBO [" + "jobEndWindow=" + jobEndWindow + "," + "jobStartWindow=" + jobStartWindow + ","
                ...
                + jobBatchSize + "," + "jobGroupId=" + jobGroupId + "," + "isAllowSplit="
                + isAllowSplit + "," + "jobThreadLimitCnt=" + jobThreadLimitCnt + "," + "jobType=" + jobType + ","
                + "isGroup=" + isGroup + ","+ "isLoop=" + isLoop + "," + "jobAlertDuration=" + jobAlertDuration + "ver=" + ver  + "]";
    }
}
