...
/**
 * 报警空操作代理对象创建工厂，创建的报警代理对象响应报警动作，但不做任何操作
 * @description 报警空操作代理对象创建工厂，创建的报警代理对象响应报警动作，但不做任何操作
 * @author bihb bihb_wb@newchinalife.com
 * @date 2015年4月13日 下午4:06:00  
 */
public class NOPAlertFactory extends BaseAlertFactory implements IAlertFactory {
    /**
     * @Fields alertProxyBeanId : 报警代理对象beanid
     */ 
    private static final String ALERT_PROXY_BEAN_ID = "nopAlertProxy";
    /**
     * @Fields factory : 单例工厂对象
     */ 
    private static final NOPAlertFactory factory = new NOPAlertFactory();
    /**
     * 私有构造函数，禁止new
     * <p>Title: 私有构造函数，禁止new</p> 
     * <p>Description: 私有构造函数，禁止new</p>  
     */
    private NOPAlertFactory() {
    }
    /**
     * @description 返回报警工厂
     * @version 1.0
     ...
     * @return 报警工厂
     */
    public static NOPAlertFactory getFactory() {
        return factory;
    }

    /**
     * 获取空操作报警代理对象
     * @description 获取空操作报警代理对象
     * @version 1.0
     * @title 获取空操作报警代理对象
     * @author bihb bihb_wb@newchinalife.com
