					...
					$("a", this).each(function(){
						if ($(this).hasClass(op.ajaxClass)) {
							$(this).click(function(event){
								...
								//扩展支持刷新控制 Liandong--------------begain
									loadedFalg=$(this).attr("loaded");
								if (this.href && !jGroup.attr("loaded")) {
									$("#pagerForm",navTab.getCurrentPanel()).html("");
								...
								//扩展支持刷新控制 Liandong--------------end
								event.preventDefault();
							});
							if (op.currentIndex == iTabIndex) $(this).click();
