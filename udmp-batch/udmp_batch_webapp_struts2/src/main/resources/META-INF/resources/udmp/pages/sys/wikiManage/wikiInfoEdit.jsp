...
<div class="pageContent">
	<form method="post" id="userForm"
		action="sys/updateWikiInfo_wikiUrlConfigAction.action?menuId=${menuId}"
			...
			<dl>
				...
				<dd>
					<input type="text" name="wikiUrlConfigAVO.wikiId" class="required"
						value="${wikiUrlConfigAVO.wikiId }" maxlength="200" />
				</dd>
			</dl>
			<dl>
				<dt>知识库名称:</dt>
				<dd>
					<input type="text" name="wikiUrlConfigAVO.wikiName"
						...
						value="${ wikiUrlConfigAVO.wikiName}" />
				</dd>
			</dl>
			<dl>
				<dt>知识库URL:</dt>
				<dd>
					<input type="text" name="wikiUrlConfigAVO.wikiUrl" class="required"
						value="${wikiUrlConfigAVO.wikiUrl }" maxlength="200" />
				</dd>
			</dl>
		</div>
		<div class="formBar">
