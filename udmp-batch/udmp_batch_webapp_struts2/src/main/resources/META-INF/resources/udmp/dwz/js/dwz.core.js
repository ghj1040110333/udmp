...
var DWZ = {
	...
	loadLogin:function(){
		if ($.pdialog && DWZ._set.loginTitle) {
			//修改为默认不许关闭 Liandong
			$.pdialog.open(DWZ._set.loginUrl, "login", DWZ._set.loginTitle, {mask:true,mixable:false,maxable:false,resizable:false,drawable:false,width:442,height:266,isClose:false});
		} else {
