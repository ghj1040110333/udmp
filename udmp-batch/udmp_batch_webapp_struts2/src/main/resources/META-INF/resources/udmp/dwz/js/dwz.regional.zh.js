...
(function($){
	...
	$.extend($.validator.messages, {
		...
		exphone:"请输入正确的电话号码",
		exmobile:"请输入正确的手机号码",
		excerticode:"请输入正确的身份证号码",
		expostcode:"请输入正确的邮编号码",
		exdate:"请输入正确的日期",
		exbankcard:"请输入正确的银行卡号",
		exchar:"请输入以字母开头的字符",
		exrange: $.validator.format("值介于 {0} 和 {1} 之间的值"),
		exmax: $.validator.format("最大值为{0}"),
		exmin: $.validator.format("最小值为{0}")
	});
