...
(function(global, factory) {
  ...
  function addRegexToken(token, regex, strictRegex) {
    regexes[token] = typeof regex === 'function' ? regex : function(
      isStrict) {
  ...
  function configFromObject(config) {
    ...
    config._a = [i.year, i.month, i.day || i.date, i.hour, i.minute, i.second,
      i.millisecond
    ];
  ...
  function cloneWithOffset(input, model) {
    ...
    return model._isUTC ? local__createLocal(input).zone(model._offset || 0) :
  ...
  function weeksInYear(year, dow, doy) {
    return weekOfYear(local__createLocal([year, 11, 31 + dow - doy]), dow,
      doy).week;
  }
  ...
  function getSetWeekYear(input) {
    var year = weekOfYear(this, this.localeData()._week.dow, this.localeData()
      ._week.doy).year;
  ...
  function pastFuture(diff, output) {
    ...
    return typeof format === 'function' ? format(output) : format.replace(
      /%s/i, output);
  }
