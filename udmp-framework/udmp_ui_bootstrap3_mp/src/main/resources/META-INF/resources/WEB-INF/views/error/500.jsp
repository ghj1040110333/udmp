...
<%@page import="cn.com.git.udmp.common.web.Servlets"%>
<%@page import="cn.com.git.udmp.common.utils.Exceptions"%>
<%@page import="cn.com.git.udmp.common.utils.StringUtils"%>
...
if (ex != null) {
	sb.append(Exceptions.getStackTrace(ex));
} else {
	sb.append("未知错误.\n\n");
}
