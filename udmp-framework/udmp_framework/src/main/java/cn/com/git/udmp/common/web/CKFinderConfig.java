...
public class CKFinderConfig extends Configuration {
    ...
    private IUDMPContext udmpContext = SpringContextHolder.getBean(Global.UDMP_CONTEXT_NAME);
    ...
    protected Configuration createConfigurationInstance() {
		Principal principal = (Principal) udmpContext.getPrincipal();
		if (principal == null){
...
//			Principal principal = (Principal)SecurityUtils.getSubject().getPrincipal();
			...
			//this.baseURL = FileUtils.path(Global.getUserfilesBaseDir() + Global.USERFILES_BASE_URL + principal + "/");
    ...
    public boolean checkAuthentication(final HttpServletRequest request) {
        return udmpContext.getPrincipal()!=null;
    }
