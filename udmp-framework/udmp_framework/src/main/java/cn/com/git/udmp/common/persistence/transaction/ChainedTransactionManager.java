package cn.com.git.udmp.common.persistence.transaction;
...
/**
 * 简单的分布式事务的实现，这个分布式实现是同时组成多个事务管理器，并进行串行的进行事务的提交和回滚
 * 实现的源http://www.javaworld.com/article/2077963/open-source-tools/distributed-transactions-in-spring--with-and-without-xa.html?page=2
 * @author Dave Syer
 *
 */
